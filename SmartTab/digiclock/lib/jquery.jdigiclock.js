...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                clockImagesPath: 'digiclock/images/clock/',
                weatherImagesPath: 'digiclock/images/weather/',
                lang: 'en',
                am_pm: false,
                weatherLocationCode: 'SAM|AR|AR021|ROSARIO',
                weatherMetric: 'C',
                weatherUpdate: 0,
                proxyType: 'php'
...
//                html    += '<p id="left_arrow"><img src="digiclock/images/icon_left.png" /></p>';
//                html    += '<p id="right_arrow"><img src="digiclock/images/icon_right.png" /></p>';
...
//                html    += '<div id="weather"></div>';
    ...
    $.fn.getWeather = function(el) {
        ...
        el.find('#weather').html('<p class="loading">Actualizando ...</p>');
        el.find('#forecast_container').html('<p class="loading">Actualizando ...</p>');
        ...
        $.getJSON('digiclock/lib/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#weather').css('background','url(' + el.weatherImagesPath + data.curr_icon + '.png) 60% 0% no-repeat');
//            el.find('#weather').css('background-size','50%');
            var weather = '<div id="local"><!--p class="city">' + data.city + '</p--><!--p>' + data.curr_text + '</p--></div>';
            weather += '<div id="temp"><p class="city">Paraná</p><p id="date">' + el.currDate + '</p>' + curr_temp + '</div>';
            ...
            el.find('#forecast_container').append('<div id="update"><img src="digiclock/images/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
